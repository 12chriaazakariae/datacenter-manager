...
@if($errors->any())
<div class="card" style="background:red; color: white; margin-bottom:10px; max-width: 620px; margin: auto; padding: 10px; margin-bottom: 10px;">
...
<div class="card anoInp" style="max-width: 600px; margin: auto;">
